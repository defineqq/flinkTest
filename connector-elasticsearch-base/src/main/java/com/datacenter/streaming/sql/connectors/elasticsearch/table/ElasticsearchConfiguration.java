...
package com.datacenter.streaming.sql.connectors.elasticsearch.table;
...
public class ElasticsearchConfiguration {
	...
	public ActionRequestFailureHandler getFailureHandler() {
		...
		switch (value.toUpperCase()) {
			...
			case "IGNORE":
				...
				break;
			// SQL中配置'failure-handler' = 'RETRY-REJECTED'时, 会走这个异常处理
			case "RETRY-REJECTED":
	...
	public Optional<String> getUsername() {
		return config.getOptional(ElasticsearchOptions.USERNAME_OPTION);
	}

	public Optional<String> getPassword() {
		return config.getOptional(ElasticsearchOptions.PASSWORD_OPTION);
	}
